...
- `STONE.md` - carved-in-stone facts, constraints, decisions, and non-negotiables.
- `ACTORS.md` - people, systems, services, teams, and named roles.
- `TOOLS.md` - local tools, commands, environment, and operational facts.
- `WORKFLOW.md` - default lifecycle, context loading, human gates, and capture rules.
