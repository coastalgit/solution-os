...
`vault/wiki/` is the curated knowledge layer for this node.

The primary navigation file is `index.md` unless the project adopts a richer index such as `_master-index.md`.

## Rules

- New wiki notes must include YAML frontmatter.
