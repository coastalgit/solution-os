...
| DEC-024 | Add root `INSTALL.md` as the public source-repo install entry point. | SRC-046 | Pointing a cloud agent at the repository should reveal the installation protocol immediately, while target repos keep their installed reference under `.claude/sos/export/`. |
